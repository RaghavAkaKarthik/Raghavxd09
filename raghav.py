...
def welcome():
	wel = """
        ...
        |            #Author: RaGvey              | 
        |	       Version 1.0                |
 	|   https://https://m.facebook.com/100000919198119     |
        +=========================================+
        |..........  Facebook Cracker  ...........|
        +-----------------------------------------+\n\n
"""
...
def moch_yayan():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start Crack ID with Dark Lord")
        ...
        def masuk():
            ...
            if "mbasic_logout_button" in str(ismi):
                if "Apa yang Anda pikirkan sekarang" in str(ismi):
                    ...
                    try:
                        requests.get(
                            mbasic.format(parser(ismi, "html.parser").find("a", string="English")["href"]),
                            cookies=cek)
                    except:
                        pass4
